...
# Best speed config for UKB 2GPU: nw10_pf2 (144 min, valid 0.9581)
...
python3 train_script_rev.py \
    ...
    --config-dir conf \
    experiment.experiment_name=${dataset}_multimodal_dense_2gpu_a100_best_nw10_pf2 \
