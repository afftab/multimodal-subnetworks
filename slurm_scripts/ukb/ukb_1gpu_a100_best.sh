...
# Best speed config for UKB 1GPU: nw18_pf4 (356 min, valid 0.9726)
...
python3 train_script_rev.py \
    ...
    --config-dir conf \
    experiment.experiment_name=${dataset}_multimodal_dense_1gpu_a100_best_nw18_pf4 \
